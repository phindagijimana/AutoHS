...
### Is it free?
Yes. AutoHS / NeuroInsight-AutoHS is publicly available source-available research software under the repository [LICENSE](../LICENSE) (non-commercial use for permitted research purposes). Commercial use requires a separate license — see [COMMERCIAL.md](../COMMERCIAL.md). FreeSurfer requires a separate license for research use.
