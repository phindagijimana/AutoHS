...
**NeuroInsight-AutoHS** ([neuroinsight_local](https://github.com/phindagijimana/neuroinsight_local)) is the full web application that implements this AutoHS pipeline.
