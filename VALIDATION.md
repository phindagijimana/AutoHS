# Independent Validation of AutoHS

## Purpose

AutoHS is made available to support reproducibility and independent validation of the hippocampal asymmetry method reported in:
...
This information helps distinguish biological or cohort differences from software-version differences.

## Citation

Publications using or evaluating this method should cite the associated Brain Communications publication and, where appropriate, the software release used for the analysis.
...
Researchers may use GitHub Issues for software-related questions or contact the project maintainer at [phindagiji@gmail.com](mailto:phindagiji@gmail.com) for scientific collaboration.

Independent validation does not imply endorsement by the original authors or institutions.
